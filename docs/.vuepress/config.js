    ...
    sidebar: {
      "/notes/": [
        ...
        },
        {
          title: "TypeScript",
          collapsable: true,
          children: ["/notes/typescript/base"],
        },
        {
          title: "Vue",
          collapsable: true,
          children: ["/notes/vue/vuex"],
        },
        {
          title: "React",
          collapsable: true,
          children: ["/notes/react/redux", "/notes/react/redux-connect"],
        },
        {
          title: "动画",
          collapsable: true,
          children: ["/notes/animation/compare-ani"],
        },
        {
          title: "服务器",
          collapsable: true,
          children: ["/notes/server/Jenkins", "/notes/server/nginx"],
        },
        {
          title: "随笔",
          collapsable: true,
          children: ["/notes/note/record1"],
        },
      ],
    },
